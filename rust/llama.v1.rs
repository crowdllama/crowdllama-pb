...
pub struct BaseMessage {
    #[prost(oneof="base_message::Message", tags="1, 2")]
    pub message: ::core::option::Option<base_message::Message>,
}
/// Nested message and enum types in `BaseMessage`.
pub mod base_message {
    #[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum Message {
        #[prost(message, tag="1")]
        GenerateRequest(super::GenerateRequest),
        #[prost(message, tag="2")]
        GenerateResponse(super::GenerateResponse),
    }
}
